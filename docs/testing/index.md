...
- [Agent Mux And Runtime E2E](./adapters-and-runtime-e2e.md) defines runtime coverage for `adapters`, `transport-mux`, `agent-core`, and `@a5c-ai/genty-platform` flows after setup preconditions are satisfied.
