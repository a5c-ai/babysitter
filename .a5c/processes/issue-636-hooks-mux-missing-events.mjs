  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Produce a current-state support matrix for every target event with columns: canonical phase, atlas/catalog mapping, hooks-mux core, Claude adapter normalize/render, CLI invoke, agent-mux runtime registration, S../tula-platform emission, docs status, and test coverage.',
        'Do not edit files.',
