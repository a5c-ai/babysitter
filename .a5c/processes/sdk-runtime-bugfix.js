...
const researchRuntimeBugTask = defineTask(
  ...
  async ({ issueNumber, title, summary, targetFiles }, ctx) => {
    return ctx.agent({
...
const reviewRuntimeBugfixTask = defineTask(
  ...
  async ({ implementation, research }, ctx) => {
    return ctx.agent({
