...
import { resolveCliLoggingConfig } from './logging-config.js';
export { resolveCliLoggingConfig } from './logging-config.js';
...
export async function main(argv?: string[]): Promise<number> {
  ...
  try {
    ...
    reconfigureLogger(resolveCliLoggingConfig({ debug, logLevel, logFile }));
