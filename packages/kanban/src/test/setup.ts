...
vi.mock('lucide-react', () => {
  ...
  const iconNames = [
    ...
    'Pause', 'Percent', 'Pin', 'Play', 'Plus', 'Power', 'Puzzle', 'RefreshCw', 'Search', 'Settings', 'Sparkles',
    'ShieldCheck', 'Siren', 'Smartphone', 'Sun', 'TabletSmartphone', 'Tag', 'Terminal', 'Timer', 'TimerReset', 'Trash2',
