...
// compaction moved to @a5c-ai/tula-platform (GAP-PERF-002)
// mcpClient moved to @a5c-ai/tula-platform (GAP-REMOTE-006)
// mcpChannels moved to @a5c-ai/tula-platform (interactive feature)
