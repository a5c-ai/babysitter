...
export const RESOURCE_DEFINITIONS = Object.freeze({
  ...
  AgentSession: { storage: 'postgres', context: 'agents', plural: 'agentsessions', purpose: 'Kradle projection of Agent Mux chat/session with lifecycle state', requiredSpec: ['organizationRef', 'agentMuxSessionId', 'dispatchRun'] },
