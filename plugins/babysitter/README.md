...
2. Plugin-local process roots under `plugins/babysitter/skills/babysit/process`
3. Other installed skill/plugin roots when present
4. Reference/bundled content only as fallback
